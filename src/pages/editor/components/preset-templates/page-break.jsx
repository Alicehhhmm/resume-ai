 ...
 */
export default function PageBreak({ widthRatio = 0.9, className = '' }) {
    return (
        <div className={`absolute -bottom-5 left-0 w-full flex items-center justify-center pointer-events-none print:hidden ${className}`}>
            <div style={{ width: `${widthRatio * 100}%` }} className='border-t border-dashed border-accent-foreground' aria-hidden />
        </div>
    )
}
